...
def get_video_paths(data_path, dataset, excluded_videos=[]):
    ...
    for folder in videos_folders:
        if folder == "boxes" or "set" in folder or folder == "splits" or folder == "actors" or folder == "crops" or folder == "DeepFakeDetection" or "zip" in folder:
            continue
        ...
        if dataset == 1:
            folder_path = os.path.join(folder_path, "c23", "videos")
